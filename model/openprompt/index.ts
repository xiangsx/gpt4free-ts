...
export class OpenPrompt extends Chat implements BrowserUser<Account> {
    ...
    async init(id: string, browser: Browser): Promise<[Page | undefined, Account]> {
        ...
        try {
            ...
            await page.waitForSelector('div > #auth-sign-in > .supabase-auth-ui_ui-container > .supabase-auth-ui_ui-container > .supabase-auth-ui_ui-anchor:nth-child(2)')
            await page.click('div > #auth-sign-in > .supabase-auth-ui_ui-container > .supabase-auth-ui_ui-container > .supabase-auth-ui_ui-anchor:nth-child(2)')

            await page.waitForSelector('#email')
            await page.click('#email')

            const emailBox = CreateEmail(process.env.EMAIL_TYPE as TempEmailType || TempEmailType.TempMailLOL)
            ...
            // signup
            await page.waitForSelector('.sm\\:mx-auto > div > #auth-sign-up > .supabase-auth-ui_ui-container > .supabase-auth-ui_ui-button')
            await page.click('.sm\\:mx-auto > div > #auth-sign-up > .supabase-auth-ui_ui-container > .supabase-auth-ui_ui-button')
