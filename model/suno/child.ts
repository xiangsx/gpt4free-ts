...
export class Child extends ComChild<Account> {
  ...
  async init() {
    ...
    if (this.info.cookies?.length) {
      ...
      page = await CreateNewPage('https://app.suno.ai/', {
        simplify: true,
        stealth: true,
        cookies: this.info.cookies,
      });
      this.logger.info('load cookies');
      ...
      // click signup
      await page.waitForSelector('div:nth-child(3) > button');
      await sleep(2 * 1000);
      await page.click('div:nth-child(3) > button');
      // click google
      await page.waitForSelector(
        'button.cl-socialButtonsIconButton:nth-child(2)',
      );
      await page.click('button.cl-socialButtonsIconButton:nth-child(2)');
      await sleep(2 * 1000);
      await loginGoogle(
        page,
        this.info.email,
